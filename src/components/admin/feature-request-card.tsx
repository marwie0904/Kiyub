...
export function FeatureRequestCard({ feature, onClick, onDelete }: FeatureRequestCardProps) {
        ...
        >
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground pt-1 border-t">
              <span className="truncate">{feature.userName || "Anonymous"}</span>

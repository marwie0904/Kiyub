...
interface CanvasHighlightPopupProps {
  selectedText: string;
...
export function CanvasHighlightPopup({
  selectedText,
  conversationContext,
  model,
  initialQuestion,
  ...
  const handleCreateCard = () => {
    console.log('Creating card from conversation...');
    console.log('Messages:', messages);

    // Create content with question/answer pairs in the requested format
    let content = '';
      ...
      >
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            className="h-7 w-7"
            title="Create card from this conversation"
          >

...
interface TestTextSelectionHandlerProps {
  children: ReactNode;
  conversationContext: any[];
  model: string;
}

export function TestTextSelectionHandler({
  children,
  conversationContext,
  model,
}: TestTextSelectionHandlerProps) {
  ...
  return (
    <>
      ...
      {showInput && !showPopup && (
        <div
          className="fixed z-[100] rounded-lg border border-border bg-background shadow-lg"
          style={{
